...
class GameObject {
  // Invalid to set constructor to function like with objects - 'constructor: function()'
  ...
  } //Comma seperating defining method(s) is not supported - would error out
  destroy() {
